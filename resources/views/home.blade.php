            ...
            <div class="container bannerContainer">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-white order-lg-1">
                        <h1 class="display-4 font-weight-bold">Shop the Best <br> Resale <span class="text-lime-600">Deals Online!</span></h1>
                        <p class="lead text-white">Looking for a high-quality, pre-owned laptop at an affordable price? You've come to the right place! At Laptop Resale Bazar, we offer a wide selection of laptops from top brands like Acer, Dell, HP. Whether you're a student on a budget, a professional looking for a reliable work computer, or just someone in need of a new laptop for personal use, we have the perfect option for you.</p>
                        <button class="btn btn-outline-warning py-1 text-xl font-bold shadow-lg"><a href="{{route('products.index')}}" class="btn btn-success py-2 m-2">Explore Now</a></button>
   ...
   <div class="container py-5 my-24">
    <div class="row align-items-center">
        <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
            <img data-aos="fade-up" src="https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1170&amp;q=80" alt="" class="img-fluid rounded-lg shadow-2xl aos-init aos-animate">
        </div>
        <div class="col-lg-6 order-lg-1">
            <h1 class="display-4 font-weight-bold text-center text-success my-8">About Us</h1>
            <p class="lead text-secondary text-justify">Laptop-Luxe is Pakistan's premier online store for laptops, offering a wide range of both new and pre-owned laptops. Since our establishment, we have been dedicated to providing reliable, high-quality laptops imported from trusted sources. At Laptop-Luxe, we prioritize exceptional customer service and cater to the diverse needs of individual buyers and corporate clients alike.</p>
        </div>
    </div>
</div>
<!-- About Us End -->
    ...
    <div class="accordion" id="faqAccordion">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                    Answer 2: No, we offer local shipping to most cities. Please check our shipping <a href="#">policy</a> for more details.
                </div>
            </div>
        </div>
